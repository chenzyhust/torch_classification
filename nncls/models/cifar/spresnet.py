...
def spresnet18(pretrained=False, progress=True, **kwargs):
...
def spresnet34(pretrained=False, progress=True, **kwargs):
...
def spresnet50(pretrained=False, progress=True, **kwargs):
...
def spresnet101(pretrained=False, progress=True, **kwargs):
...
def spresnet152(pretrained=False, progress=True, **kwargs):
