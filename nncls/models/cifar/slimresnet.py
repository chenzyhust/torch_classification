...
class Bottleneck(nn.Module):
    ...
    def __init__(self, inplanes, planes, stride=1, downsample=None, groups=1,
        ...
        self.conv2 = slim_conv_3x3(width, stride, groups, dilation)
        self.conv3 = conv1x1(width//2+width//4, planes * self.expansion)
    ...
    if pretrained:
        ...
        for name, param in learn_state_dict.items():
            ...
            if name in checkpoint['state_dict']:
                input_param = checkpoint['state_dict'][name]
...
def slimresnet50(pretrained=False, progress=True, **kwargs):
